...
DEL_JOINED = CommandHandler("deljoined", del_joined, pass_args=True, filters=Filters.group)
WELCOME_HELP = CommandHandler("welcomehelp", welcome_help)
DEL_JOINED_HANDLER = MessageHandler(Filters.status_update.new_chat_members, delete_join)
